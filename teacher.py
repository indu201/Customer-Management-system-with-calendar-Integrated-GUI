...
def insert():
    ...
    cur = db.cursor()
    s = "insert into teacher values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"%(k, k2, k3, k4, n, k6, k7, k8, k9, k10)
...
L=Label(top, text="TeacherRegistration", bg="tomato", fg="white", font=("Arial 30 bold"))
L.place(x=600, y=30)

L2=Label(top, text="Name", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
L2.place(x=150, y=150)

e1=Entry(top, font=("Arial 20 bold"))
e1.place(x=300, y=150)

L3=Label(top, text="Lastname", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
L3.place(x=150, y=200)

e2=Entry(top, font=("Arial 20 bold"))
e2.place(x=300, y=200)

L4=Label(top, text="Contact", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
L4.place(x=150, y=250)

e3=Entry(top, font=("Arial 20 bold"))
e3.place(x=300, y=250)

L5=Label(top, text="Age", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
L5.place(x=150, y=300)

e4=Entry(top, font=("Arial 20 bold"))
e4.place(x=300, y=300)

L6=Label(top, text="DOB", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
L6.place(x=150, y=350)

cal = DateEntry(top, width=18, bg="dark slate gray", fg="white", font=("Arial 20 bold"), year=2020)
cal.place(x=300, y=350)

L7=Label(top, text="Qualification", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
...
L8=Label(top, text="Gender", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
L8.place(x=150, y=450)

L9=Label(top, text="City", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
...
L10=Label(top, text="Subject", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
...
L11=Label(top, text="Exp", bg="dark slate gray", fg="white", font=("Arial 20 bold"))
